...
- [x] **Step 1: Replace expected package fixtures with `com.nexwit.tarot`.**
- [x] **Step 2: Run the focused tests and verify they fail because production configuration still uses `com.apptaro.app`.**
...
- [x] **Step 1: Set every production package source to `com.nexwit.tarot`.**
- [x] **Step 2: Move `MainActivity.kt` to `com/nexwit/tarot` and update its Kotlin package declaration.**
- [x] **Step 3: Increase the Flutter build number from `14` to `15`.**
- [x] **Step 4: Run focused tests and require all tests to pass.**
...
- [x] **Step 1: Run `flutter analyze` and `flutter test`.**
- [x] **Step 2: Run the complete backend test suite.**
- [x] **Step 3: Build signed release AAB and APK.**
- [x] **Step 4: Inspect artifact metadata and require package `com.nexwit.tarot`, version code `15`.**
...
- [x] **Step 1: Deploy the full stack to `/root/PMapptaro`.**
- [x] **Step 2: Verify backend and admin-bot container health.**
...
- [x] **Step 1: Write the app name, short description, full description, category, support details, privacy notes, and release notes.**
- [x] **Step 2: Verify character limits: title at most 30, short description at most 80, full description at most 4000.**
...
- Create: `docs/store/google-play/en-US/phone/04-language.png`
- Create: `docs/store/google-play/en-US/phone/README.md`

- [x] **Step 1: Start Flutter Web against the production backend.**
- [x] **Step 2: Use Playwright to exercise the English home, question, reading, and support/language flows.**
- [x] **Step 3: Capture clean 9:16 screenshots and export each as 24-bit `1080x1920` PNG.**
- [x] **Step 4: Inspect every screenshot for correct language, readable text, no debug UI, no browser chrome, no personal data, and no distortion.**
...
- [x] **Step 1: Run the full local and remote readiness check.**
- [x] **Step 2: Record artifact paths, package, version, API status, screenshot paths, and remaining real Play purchase test.**
